...
_CONFIG_FNAME = 'deterministic_apg_network_config.json'
...
def network_config(
    ...
    network_factory: types.NetworkFactory[Union[apg_networks.DeterministicAPGNetworks]],
...
def _get_unroll_apg_network(
    config: config_dict.ConfigDict,
    network_factory: types.NetworkFactory[apg_networks.DeterministicAPGNetworks],
) -> apg_networks.DeterministicAPGNetworks:
