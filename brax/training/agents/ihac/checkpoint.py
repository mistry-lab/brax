...
from brax.training.agents.ihac import networks as diffrl_shac_networks
from etils import epath
from ml_collections import config_dict

_CONFIG_FNAME = 'ihac_network_config.json'
...
def network_config(
    ...
    network_factory: types.NetworkFactory[Union[diffrl_shac_networks.IHACNetworks]],
...
def _get_diffrl_shac_network(
    config: config_dict.ConfigDict,
    network_factory: types.NetworkFactory[diffrl_shac_networks.IHACNetworks],
) -> diffrl_shac_networks.IHACNetworks:
...
def load_policy(
    ...
    network_factory: types.NetworkFactory[
        diffrl_shac_networks.IHACNetworks
    ] = diffrl_shac_networks.make_ihac_networks,
