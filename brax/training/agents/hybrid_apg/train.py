...
from brax.training import gradients, dual_gradients
from brax.v1 import envs as envs_v1

from brax.training.agents.hybrid_apg import checkpoint
from brax.training.agents.hybrid_apg import losses as hybrid_losses
from brax.training.agents.hybrid_apg import networks as apg_networks
from brax.training.dual_gradients import NetworkTrainingState
...
def _init_training_state(
    ...
    policy_params = apg_network.policy_network.init(key_policy)
    policy_optimizer_state = policy_optimizer.init(policy_params)
    value_params = apg_network.value_network.init(key_value)
...
def train(
    ...
    network_factory: types.NetworkFactory[
              apg_networks.HybridAPGNetworks] = apg_networks.HybridAPGNetworks,
    ...
    ppo_loss, actor_loss = hybrid_losses.make_losses(
    ...
    ppo_update = dual_gradients.dual_gradient_update_fn(
        ppo_loss,
    ...
    def minibatch_step(
        ...
        critic_loss, policy_training_state, value_training_state = ppo_update(
            training_state.policy_training_state.params,
            training_state.value_training_state.params,
            normalizer_params,
            data,
            key_loss,
            policy_optimizer_state=training_state.policy_training_state.optimizer_state,
            value_optimizer_state=training_state.value_training_state.optimizer_state,
        )

        training_state = training_state.replace(
            policy_training_state=policy_training_state,
            value_training_state=value_training_state,
        )
