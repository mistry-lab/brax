...
from brax.training.agents.diffrl_shac import networks as diffrl_shac_networks
from etils import epath
from ml_collections import config_dict

_CONFIG_FNAME = 'generalized_hac_network_config.json'
...
def network_config(
    ...
    network_factory: types.NetworkFactory[Union[diffrl_shac_networks.DiffRLSHACNetworks]],
...
def _get_diffrl_shac_network(
    config: config_dict.ConfigDict,
    network_factory: types.NetworkFactory[diffrl_shac_networks.DiffRLSHACNetworks],
